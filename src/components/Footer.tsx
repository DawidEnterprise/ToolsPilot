        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              ...
              <li><Link href="/tools-list" className="text-sm text-gray-500 hover:text-brand-600 transition-colors dark:text-gray-400 dark:hover:text-brand-400">All 163 Tools</Link></li>
            </ul>
          </div>
        </div>
