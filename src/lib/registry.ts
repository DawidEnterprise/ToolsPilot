...
export const tools: ToolDefinition[] = [
  ...
  },
  {
    ...
    category: "misc",
    icon: "misc",
    keywords: ["temperature", "converter", "celsius", "fahrenheit", "kelvin", "celsius to fahrenheit", "fahrenheit to celsius", "temperature converter", "convert temperature", "°C to °F", "°F to °C"],
    relatedTools: ["unit-converter", "weight-converter", "length-converter"],
    layout: 'compact',
  },
  {
    slug: "weight-converter",
    name: "Weight Converter",
    description: "Convert between kilograms, pounds, ounces, grams, stone, and tonnes. Free online weight converter.",
    category: "misc",
    icon: "misc",
    keywords: ["weight", "converter", "kg", "lbs", "pounds", "ounces", "grams", "stone", "kg to lbs", "lbs to kg", "weight converter", "convert weight", "mass converter"],
    relatedTools: ["unit-converter", "temperature-converter", "length-converter"],
    layout: 'compact',
  },
  {
    slug: "length-converter",
    name: "Length Converter",
    description: "Convert between meters, feet, inches, miles, kilometers, and more. Free online length converter.",
    category: "misc",
    icon: "misc",
    keywords: ["length", "converter", "meters", "feet", "inches", "miles", "kilometers", "cm to inches", "feet to meters", "miles to km", "length converter", "distance converter", "convert length"],
    relatedTools: ["unit-converter", "temperature-converter", "weight-converter"],
    layout: 'compact',
  },
  {
    slug: "contrast-checker",
    name: "Color Contrast Checker",
    description: "Check WCAG color contrast ratios for accessibility compliance. Test text and background color combinations.",
    category: "developer",
    icon: "code",
    keywords: ["contrast", "checker", "WCAG", "accessibility", "a11y", "color", "ratio", "contrast checker", "color contrast", "WCAG contrast", "accessibility checker", "contrast ratio calculator"],
    relatedTools: ["color-converter", "color-palette-generator", "hex-to-rgb"],
  },
  ...
  },
  {
    ...
    relatedTools: ["pdf-splitter", "pdf-compressor"],
  },
  {
