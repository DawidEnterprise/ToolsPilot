    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <div>
          ...
          <textarea className="textarea-field tool-panel bg-gray-50 dark:bg-gray-800" value={output} readOnly placeholder="Sorted output…" spellCheck={false} />
        </div>
      </div>
    </div>
  );
