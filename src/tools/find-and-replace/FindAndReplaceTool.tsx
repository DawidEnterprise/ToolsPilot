...
export function FindAndReplaceTool() {
  ...
  return (
    <div className="space-y-4">
      ...
      <textarea className="input-field min-h-[200px]" value={text} onChange={(e) => setText(e.target.value)} placeholder="Paste your text here..." />
      ...
      {result.output && result.output !== text && (
        <div className="relative">
          ...
          <pre className="max-h-64 overflow-auto rounded-lg border border-gray-200 bg-gray-50 p-4 text-sm whitespace-pre-wrap dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100">
            {result.output}
          </pre>
        </div>
      )}
