    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div>
          ...
          <textarea className="input-field tool-panel font-mono" placeholder={mode === "encode" ? "Enter text..." : "Enter hex (space-separated)..."} value={input} onChange={e => setInput(e.target.value)} />
        </div>
        <div>
